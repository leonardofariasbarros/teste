...
public class Adapter2 extends BaseAdapter {
    ...
    public Adapter2(List<Carrinho> carrinhos, Activity act) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = act.getLayoutInflater()
                .inflate(R.layout.listameucarrinho, parent, false);
        ...
        TextView sub = (TextView)
                view.findViewById(R.id.textSubtotal);
        ImageView imagem = (ImageView)
                view.findViewById(R.id.imgProduto);

        DecimalFormat df = new DecimalFormat("#0.00");
        df.format(00.00);
        float subtotal = Float.parseFloat(carrinho.getQuantidade())*Float.parseFloat(carrinho.getPreco());
        String st = ("" + df.format(subtotal));

        quantidade.setText(carrinho.getQuantidade());
        nome.setText(carrinho.getNome());
        descricao.setText(carrinho.getDescricao());
        preco.setText(carrinho.getPreco());
        sub.setText(st);
